                ...
                <View style={{ gap: 12 }}>
                  ...
                  <View style={{ marginLeft: 40, flexDirection: "row", alignItems: 'center' }}>
                    ...
                    <View style={{ flexDirection: 'row', alignItems: 'center' }}>
                      ...
                      <Text style={{ marginLeft: 50, margin: 2, flex: 1, fontSize: 18, color: colors.text }}>LKR {(120000000).toLocaleString()}</Text>
                    </View>
                  ...
                  <View style={{ marginTop: 20, marginLeft: 40, flexDirection: "row", alignItems: 'center' }}>
                    <View style={{ flexDirection: 'row', alignItems: 'center' }}>
                      ...
                      <Text style={{ marginLeft: 50, margin: 2, flex: 1, fontSize: 18, color: colors.text }}>LKR {(400).toLocaleString()}</Text>
                    </View>
                  ...
                  <View style={{ marginTop: 20, marginLeft: 40, flexDirection: "row", alignItems: 'center' }}>
                    <View style={{ flexDirection: 'row', alignItems: 'center' }}>
                      ...
                      <Text style={{ marginLeft: 3, opacity: 0.75, margin: 4, flex: 1, fontSize: 27, color: colors.text, fontWeight: '600' }}>LKR {(40000).toLocaleString()}</Text>
                    </View>
